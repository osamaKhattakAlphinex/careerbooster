...
import { CouponConfirmationModalRef } from "../coupons/ViewCoupons";
...
const ViewPackage = ({}) => {
  ...
  const confirmationModalRef: React.MutableRefObject<CouponConfirmationModalRef | null> = useRef(null);
  ...
  const actions: TableAction[] = [
...

    {
      name: "preview",
      type: "component",
      element: (pckg: Package) => <ReadPackage userPackage={pckg} />,
      styles:
...

    {
      name: "delete",
      type: "handler",
      element: (pckg: Package) => handleOpenConfirmationModal(pckg),
      styles:
