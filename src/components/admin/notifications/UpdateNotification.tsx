          ...
          <div className="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button
                ...
                type="submit"
                className={`border border-gray-300 inline-flex items-center  hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 ${(formData.message && formData.title && formData.sender) === ""
                    ? "bg-gray-400"
                    : "bg-primary-700"
                  }`}
              >
