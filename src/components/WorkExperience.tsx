...
import EditableField from "./new-dashboard/common/EditableField";
import { setWorkExperienceArray } from "@/store/resumeSlice";
...
type Props = {
    rec: any,
    i: number,
    handleDropExperience: any,
    handleDropAchievement: any,
}
const WorkExperience = ({ rec, i, handleDropExperience, handleDropAchievement }: Props) => {
