...
const LinkedInUploadPDFResume = () => {
  ...
  const [linkedinFileName, setLinkedinFileName] = useState<string>("");
  ...
  useEffect(() => {
    ...
    if (data) {
      setLinkedinContent(data.linkedinContent as string);
      setLinkedinFileName(data.linkedinFileName as string);
    }
  }, []);
