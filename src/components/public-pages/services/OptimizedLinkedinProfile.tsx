...
function OptimizedLinkedinProfile() {
  return (
    <div
      className={`md:mx-10 md:px-10 xs:mx-4 xs:px-2 my-10 shadow-lg border-2 border-gray-100 rounded-xl  lg:py-20 md:py-10 xs:py-8`}
    >
      <hr className="text-gray-100 lg:pb-20 md:pb-10 xs:pb-6" />
      ...
      <h1
        className={`lg:text-[54px] md:text-[44px] xs:text-[24px] ${fjalla_One.className} text-center text-[#6350C8] py-10 md:px-4`}
      >
        <strong>
      ...
      <h1
        className={`lg:text-[42px] md:text-[36px] xs:text-[22px] ${fjalla_One.className}   md:py-10 xs:py-6 lg:pr-40 xs:text-center md:text-left`}
      >
        <strong>
      ...
      <Image
        ...
        className="mx-auto"
      />
      <div className="flex flex-col gap-4 md:mt-20 xs:mt-6">
        <p
