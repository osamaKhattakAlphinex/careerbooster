...
function Interests() {
  return (
    <div className={`shadow-xl rounded-md flex flex-col gap-8  pt-8`}>
      <h2
        className={`text-gray-300 lg:text-[44px] md:text-[32px] xs:text-[20px] text-center lg:px-20 md:px-10 ${montserrat_500.className}`}
      >
      ...
      <div className="md:px-20 xs:px-4 flex flex-col md:gap-8 xs:gap-4 xs:text-justify">
        <p
          className={`${lato_400.className} text-gray-300 md:text-[20px] xs:text-base`}
        >
        ...
        <p
          className={`${lato_400.className} md:text-[20px] xs:text-base text-gray-300`}
        >
