        ...
        <div className=" grid grid-cols-1 md:grid-cols-2 gap-y-20 lg:gap-x-20">
          <div className="col">
            <div className="text-center">
              <div className="w-16 h-16 rounded-md p-4 inline-flex items-center justify-center bg-[#E6F85E] text-[#11121c] mb-8">
                <svg
              ...
              <h4 className=" font-medium mb-0 text-gray-900 dark:text-gray-400 px-4 text-2xl">
          ...
          <div className="col">
            <div className="text-center">
              ...
              <h4 className="font-medium text-2xl mb-0 text-gray-900 dark:text-gray-400">
                +44 7933 951034
              </h4>
            </div>
          </div>
