...
const Header = () => {
  ...
  return (
    <nav
      className={`translate-y-[0%] xs:h-[54.88px] lg:h-[90.06px] opacity-[1] fixed top-0 left-0 w-full right-0 z-50 dark:bg-gray-950/95 bg-gray-100/95  on-over shadow-lg  dark:text-gray-100 text-gray-900`}
    >
