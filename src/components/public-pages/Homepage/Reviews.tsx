...
const Reviews = () => {
  return (
    <section className="overflow-hidden  pb-10  pb-lg-15  z-[2000000]  dark:bg-gray-950 bg-gray-100">
            ...
            <div className=" rounded h-full p-6 border-[1px]  bg-gray-100 text-gray-950 border-gray-500 dark:bg-transparent dark:text-gray-100 dark:border-gray-500 border-opacity-10">
              ...
              <div className="">
                ...
                <p className="review-text mb-0">
                  ...
                  resume and LinkedIn for each opportunity.CareerBooster.AI
            ...
            <div className="review-card rounded h-full p-6 border-[1px] bg-gray-100 text-gray-950 border-gray-500 dark:bg-transparent dark:text-gray-100 dark:border-gray-500 border-opacity-10">
              ...
              <div className="">
                ...
                <p className="review-text mb-0">
                  ...
                  recruiters saved me time and helped me connect with the right
                  opportunities.
                </p>
              </div>
            </div>
            ...
            <div className="review-card rounded h-full p-6 border-[1px] bg-gray-100 text-gray-950 border-gray-500 dark:bg-transparent dark:text-gray-100 dark:border-gray-500 border-opacity-10">
              ...
              <div className="">
                ...
                <p className="review-text mb-0">
                  ...
                  CareerBooster.AI played a crucial role in my successful career
                  transition.
                </p>
              </div>
            </div>
            ...
            <div className="review-card rounded h-full p-6 border-[1px] bg-gray-100 text-gray-950 border-gray-500 dark:bg-transparent dark:text-gray-100 dark:border-gray-500 border-opacity-10">
              ...
              <div className="">
                ...
                <p className="review-text mb-0">
                  ...
                  letters and optimized LinkedIn profile were the icing on the
                  cake.
                </p>
              </div>
            </div>
            ...
            <div className="review-card rounded h-full p-6 border-[1px] bg-gray-100 text-gray-950 border-gray-500 dark:bg-transparent dark:text-gray-100 dark:border-gray-500 border-opacity-10">
              ...
              <div className="">
                ...
                <p className="review-text mb-0">
                  ...
                  firms, and it was all thanks to CareerBooster.AI.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="review-card rounded h-full p-6 border-[1px] bg-gray-100 text-gray-950 border-gray-500 dark:bg-transparent dark:text-gray-100 dark:border-gray-500 border-opacity-10">
              ...
              <div className="">
                ...
                <p className="review-text mb-0">
                  ...
                  executives serious about their careers.
                </p>
              </div>
            </div>
          </div>
