    ...
    <section className="md:pt-20 xs:pt-[0px] xs:pb-[50px] pb-10  md:pb-18  dark:bg-gray-950 bg-gray-100 dark:text-white text-gray-950  justify-center items-center min-h-screen flex flex-col">
      ...
      <div className="flex md:flex-row xs:flex-col justify-center md:p-4 w-full gap-4 md:px-14 xs:px-2 mt-20">
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="flex items-center xs:p-2 md:p-4 bg-[#E4ECF2] xs:rounded-3xl md:rounded-full">
                ...
                <p
                  className={`text-gray-950 ${montserrat_r.className} md:text-[20px] xs:text-[16px] text-center pl-4`}
                >
                  Spend <strong>44 hours</strong> sending network messages and
                  new connections requests. (2 hours a day)
                </p>
              </div>
              <span className="w-1 h-8 bg-gray-950 dark:bg-gray-100 mx-4"></span>
        ...
        <div className="flex flex-col w-full">
          ...
          <div className=" text-black">
            <div className="flex flex-col items-center">
              <div className="flex items-center p-4 bg-white xs:rounded-3xl md:rounded-full">
              ...
              <div className="flex items-center xs:p-2 md:p-4 bg-[#E4ECF2] xs:rounded-3xl md:rounded-full">
                ...
                <p
                  className={`text-gray-950 ${montserrat_r.className} md:text-[20px] xs:text-[16px] text-center pl-4`}
                >
                  Spend <strong>0 hours</strong> finding 100 jobs a month. (We
                  do it for you)
                </p>
              </div>
              <span className="w-1 h-8 bg-gray-950 dark:bg-gray-100 mx-4"></span>
              ...
              <div className="flex items-center xs:p-2 md:p-4 bg-[#E4ECF2] xs:rounded-3xl md:rounded-full">
                ...
                <p
                  className={`text-gray-950 ${montserrat_r.className} md:text-[20px] xs:text-[16px] text-center pl-4`}
                >
                  Spend <strong>0 hours</strong> sending network messages and
                  new connections requests. (We do it)
                </p>
              </div>
              <span className="w-1 h-8 bg-gray-950 dark:bg-gray-100 mx-4"></span>
              <div className="flex items-center xs:p-2 md:p-4 bg-white xs:rounded-3xl md:rounded-full">
              ...
              <div className="flex items-center xs:p-2 md:p-4 bg-white xs:rounded-3xl md:rounded-full">
                ...
                <p
                  className={`text-gray-950 ${montserrat_r.className} md:text-[20px] xs:text-[16px] text-center pl-4`}
                >
                  Higher likelihood of generating several offers, that way
                  you’re not only finding A job, but the RIGHT job.
                </p>
              </div>
            </div>
          </div>
