              ...
              <div className="flex flex-col px-4">
                <div className="text-center pt-6 px-2 md:pt-10 lg:pt-20 lg:px-20">
                  ...
                  <p className="dark:text-gray-100 text-gray-950 pb-5 text-base mb-6">
                    ...
                    document for every job application? Break free from
                    old-school methods and learn the secret to crafting
                    job-specific resumes effortlessly - in just 2-3 minutes! Don
                    {"'"}t miss out on your dream job - embrace the future of
                    job hunting now!
                  </p>

                  <Link
                    href="/register"
                    className="rounded-lg z-10 relative dark:text-gray-950 no-underline px-6 py-4 bg-[#6a4dff] hover:bg-[#5840cc] text-gray-100 dark:bg-[#e6f85e] dark:hover:bg-[#c2da55] cursor-pointer"
                  >
                    Get Started Free
                  </Link>
