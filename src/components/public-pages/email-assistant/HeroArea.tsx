          ...
          <div className="xs:mt-5 md:mt-4 lg:mt-10 container mx-auto">
            <ul>
              ...
              <li>
                ...
                <ul
                  className={`text-[10px] list-disc md:text-[13px] lg:text-[18px] text-gray-800 dark:text-gray-300 flex flex-col xs:gap-2 md:gap-4 xs:my-2 md:my-4 ${montserrat_p.className}`}
                >
                  <li>
                    <strong>
                  ...
                  Ensure your emails are clear, concise, and professional, making a strong first impression.
                  </li>
              ...
              <li>
                ...
                >
                  Focus on what matters most – your career goals! Let our AI assistant handle the communication details.
                </h3>
              </li>
            </ul>
          </div>
