      ...
      <div className="text-white bg-[#17151B] rounded-2xl my-7 py-5">
        <div className="flex justify-between items-center px-5 py-[10px] ">
          ...
          <div className="relative w-[213px]">
            <input
              className="w-full pl-4 h-[38px] py-2 placeholder:text-[#5B5B5B] rounded-full border-[1px] border-[#312E37] placeholder-gray-400 text-white focus:outline-none focus:border-zinc-600 bg-transparent"
              type="text"
