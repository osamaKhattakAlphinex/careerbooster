...
const ResumeTemplate3 = ({
  ...
  return (
    <div className="first-page  text-gray-900">
      ...
      <div className=" flex">
        <div className=" w-5/12 md:w-1/3 flex flex-col pl-3 md:pl-8 bg-red-100 h-[30%] pr-6 border-r-2 ">
          {/* contacts */}
        ...
        <div className="w-full flex flex-wrap flex-col px-4 md:px-8">
          {/* Executive Summary */}
          <span className="border-stylee w-full h-0 border !border-gray-500 my-3"></span>
            ...
            <>
              {resume?.workExperienceArray.map((rec: any, i: number) => {
                return (
                  <div
                    key={i}
                    className="hover:border-dashed hover:border-gray-500 hover:cursor-move hover:border-2 w-full flex flex-wrap"
