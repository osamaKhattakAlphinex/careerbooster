  ...
  return (
    <div className="w-full first-page  text-gray-900">
      ...
      <div className="flex border-t-2 border-b-2 border-gray-500 p-5">
        <div className=" w-5/12 md:w-1/3 flex flex-col pl-3 md:pl-8 pr-6 gap-4 ">
          {/* contacts */}
          ...
          <span className="border-2 border-dotted	border-gray-500"></span>
          ...
          {resume?.education && (
            <>
              <span className="w-full h-0 border-dotted border-2 border-gray-500 my-3 page-break mt-4"></span>
        ...
        <span className="border-gray-500 border"></span>
