...
const ResumeTemplate4 = () => {
  ...
  return (
    // <div className="first-page flex">
    <>
      {/* SideBar */}
      <div className=" z-10 absolute  w-3/12 xs:w-1/3 md:w-3/12 flex flex-col pl-3 md:pl-4 bg-[#323B4C] text-gray-100  pr-6 md:pr-4  py-8 h-[1080px] ">
        ...
        <ul className=" flex flex-col gap-2 mb-4 text-4 break-all pl-0">
      ...
      <div id="sidebar-template" className=" w-full flex flex-wrap flex-col px-4 md:px-8 text-gray-950 pb-10 pt-16">
        ...
        <h3 className=" text-[#000] uppercase text-lg xs:text-sm sm:text-sm md:text-md lg:text-lg font-semibold mt-8">
          EXECUTIVE SUMMARY
        </h3>
