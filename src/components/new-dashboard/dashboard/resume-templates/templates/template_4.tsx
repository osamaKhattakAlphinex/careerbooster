...
const ResumeTemplate4 = ({
  ...
  return (
    <div className="first-page grid-flow-row ">


      <div className=" w-[250px] h-[1123px]   flex flex-col pl-3 md:pl-8 bg-[#323B4C] text-gray-100  pr-6  py-8  ">
      ...
      <div className=" px-4 md:px-8 text-gray-950 pb-10 pt-16">
        ...
        <span className="border-stylee block w-full h-0 border !border-gray-500 my-3"></span>
        ...
        <div className="w-full flex flex-grow flex-wrap flex-col  text-gray-950 pb-10 pt-16">
          <h3 className="uppercase text-lg font-semibold mt-12">
            WORK EXPERIENCE
          </h3>
          <span className="border-stylee block w-full h-0 border !border-gray-500 my-3"></span>
