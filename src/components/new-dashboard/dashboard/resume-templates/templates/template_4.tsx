...
const ResumeTemplate4 = ({
  ...
  return (
    <div className="first-page  ">
      <div className=" flex">
        <div className=" w-5/12 md:w-1/3 flex flex-col pl-3 md:pl-8 bg-[#323B4C] text-gray-100  pr-6  py-8 h-auto ">
              ...
              {resume?.workExperienceArray.map((rec: any, i: number) => {
                return (
                  <div key={i} className="flex justify-center items-center">
                    ...
                    <div
                      key={i}
                      className="hover:border-dashed hover:border-gray-500 hover:cursor-move hover:border-2  flex flex-wrap w-[95%] ml-[16px]"
