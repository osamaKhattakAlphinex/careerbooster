          ...
          {resume?.primarySkills && resume?.primarySkills.length > 0 && (
            <>
              ...
              !regenerating ? (
                ...
                >
                  <ul
                    className="border-2 border-transparent hover:border-dashed hover:border-gray-500 pl-0 flex  px-0 xs:px-0 md:px-0  flex-col gap-1 mb-4 text-gray-800 w-full text-sm"
                    onMouseEnter={() =>
