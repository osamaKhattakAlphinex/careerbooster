...
const ResumeTemplate16 = () => {
  ...
  return (
    <div className="w-full first-page relative text-gray-900">
      <div className="flex">
        <div className=" w-4/12 xs:w-4/12 md:w-1/3 flex flex-col  items-center   bg-[#1F1E1E]  px-9  xs:px-1 md:px-9 pt-[2rem] h-[1200px] xs:h-auto">
          ...
          {resume?.primarySkills && resume?.primarySkills.length > 0 && (
            <>
              ...
              !regenerating ? (
                ...
                >
                  <ul
                    className="border-2 border-transparent hover:border-dashed hover:border-gray-500 pl-0 flex  flex-col gap-1 mb-4 text-gray-300 w-full text-[16px] "
                    onMouseEnter={() =>
