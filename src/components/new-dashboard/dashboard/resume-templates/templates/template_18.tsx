          ...
          {resume?.primarySkills && resume?.primarySkills.length > 0 && (
            <>
              ...
              !regenerating ? (
                ...
                >
                  <ul
                    className="border-2 border-transparent hover:border-dashed hover:border-gray-500 pl-0 flex  flex-col xs:px-1 md:px-0 gap-1 mb-4 text-gray-300 w-full text-sm "
                    onMouseEnter={() =>
