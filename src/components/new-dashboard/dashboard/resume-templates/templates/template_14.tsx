...
const ResumeTemplate14 = () => {
  ...
  return (
    <div className="w-full first-page relative p-4  text-gray-900">
      ...
      <div className="flex">
        <div className="w-3/12 xs:w-3/12 md:w-3/12 flex flex-col bg-[#E3DBCC] pl-3 md:pl-8 pr-6 pt-[15rem]  xs:pt-[14rem] md:pt-[15rem]  h-[1020px] xs:h-auto lg:pt-[15rem]  ">
          {/* contacts */}
                  ...
                  >
                    ...
                    >
                      <div className="flex">
                        ...
                        <div>
                          <h2 className="hover:shadow-md ml-0 xs:-ml-3 md:ml-0 hover:cursor-text text-[1rem] xs:text-[1rem] md:text-[1rem] lg:text-[1rem]   font-semibold   hover:bg-gray-100">
                            <EditableField
                              value={rec?.title}
                              style={{ width: "100%" }}
                              onSave={(value: string) => {
