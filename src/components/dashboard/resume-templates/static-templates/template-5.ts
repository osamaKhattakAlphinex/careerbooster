...
const components: any = {
  ...
  jobTitle: {
    tag: "span",
    styles:
      "text-base flex justify-left text-gray-950 items-center w-full mb-2",
  },
  contact: {
    styles: "",
    elements: [
  ...
  workExperienceArray: {
    ...
    elements: [
      ...
      },
      {
        ...
        container: [
          ...
          { id: "toYear", styles: "text-gray-950", tag: "span" },
          {
            id: "company",
            styles:
              "before:content-['\\2758'] text-gray-950 before:mr-2 after:content-['\\2758'] after:ml-2",
            tag: "span",
          },
      ...
      },
      {
        id: "achievements",
        styles:
          "text-xs flex text-justify pb-1 before:content-['\\2022'] text-gray-950 before:mr-2",
        tag: "span",
      },
    ],
  },
