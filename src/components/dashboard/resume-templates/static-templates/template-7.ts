...
const components = {
  ...
  languages: {
    ...
    elements: [
      {
        tag: "div",
        styles: "flex flex-row justify-start items-center w-[30%] p-2",
        container: [
          {
            id: "language",
