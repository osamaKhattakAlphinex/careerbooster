...
const components: any = {
  ...
  education: {
    ...
    elements: [
      {
        tag: "div",
        styles: "flex flex-col w-[30%] p-1 rounded-md",
        container: [
          {
            id: "educationLevel",
