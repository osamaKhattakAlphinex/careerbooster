  ...
  contact: {
    ...
    elements: [
      ...
      },
      {
        id: "linkedIn",
        styles:
          "text-xs mt-2 flex break-all before:break-normal  text-gray-100  before:w-4 before:h-4 items-center before:border-gray-300 flex before:text-[10px] before:font-semibold  before:border-[1.5px] before:p-1.5  before:flex before:justify-center before:rounded-sm before:items-center flex before:mr-3 flex before:ml-1  before:content-['in']",
        tag: "span",
      },
      {
        id: "address",
