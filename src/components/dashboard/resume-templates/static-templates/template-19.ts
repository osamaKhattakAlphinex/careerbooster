const cvHeadings: any = [
  ...
  const templateLayout: any = {
    ...
    fragment: {
      ...
      header: {
        styles:
          "text-black m-2 flex flex-col items-center",
        elements: [
          {
            id: "name",
          },
  ...
  const components: any = {
    ...
    name: {
      styles:
        "text-2xl font-bold flex text-gray-950/80 items-center mx-6",
      tag: "span",
    },
    jobTitle: {
      tag: "span",
    ...
    trainings: {
      ...
      elements: [
        ...
        {
          styles: "flex gap-1 font-semibold pb-2 text-xs flex-wrap text-gray-950/80",
          tag: "div",
          container: [
