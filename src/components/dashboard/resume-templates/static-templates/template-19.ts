...
const templateLayout: any = {
  ...
  fragment: {
    ...
    header: {
      styles: "text-black m-2 flex flex-col items-center",
      elements: [
        {
          id: "name",
        },
...
const components: any = {
  ...
  name: {
    styles: "text-2xl font-bold flex text-gray-950/80 items-center mx-6",
    tag: "span",
  },
  jobTitle: {
    tag: "span",
    styles: "text-base flex text-gray-950/80 px-6 ",
  },
  contact: {
    styles: "w-full",
    elements: [
  ...
  workExperienceArray: {
    ...
    elements: [
      {
        styles:
          "flex gap-1 items-end justify-between font-semibold pb-1 text-xs flex-wrap",
        tag: "div",
        container: [
          {
            id: "title",
          ...
          {
            styles: "flex gap-1 font-semibold text-xs flex-wrap",
            tag: "div",
            container: [
              {
                id: "cityState",
                styles:
                  "before:w-4 after:content-[','] after:ml-1 before:h-4 before:text-gray-950/80 before:mr-2 text-gray-950/80",
                tag: "span",
              },
              {
                id: "country",
                styles:
                  "text-gray-950/80 before:w-4 before:h-4 before:text-gray-950/80",
                tag: "span",
              },
            ],
          },
      ...
      {
        styles: "flex gap-1 justify-between font-semibold pb-2 text-xs flex-wrap",
        tag: "div",
        container: [
          {
            id: "company",
            styles:
              "before:w-4 before:h-4 before:text-gray-950/80 text-gray-950/80",
            tag: "span",
          },
          {
            styles: "flex gap-1 font-semibold text-xs flex-wrap",
