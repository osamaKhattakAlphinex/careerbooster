    ...
    <div className="w-full text-gray-900 first-page">
      ...
      <div className="flex">
        <div className="flex flex-col w-full px-8 xs:px-4 md:px-8 lg:px-8">
          ...
          <span className="!block border-stylee w-full h-0 border-[1px] !border-gray-900 mb-2"></span>
          ...
          {resume?.primarySkills && resume?.primarySkills.length > 0 && (
            <>
              ...
              <span className="!block border-stylee w-full h-0 border-[1px] !border-gray-900 mb-3"></span>
                  ...
                  <ul className="border-2 border-transparent hover:border-dashed hover:border-gray-500  pl-0 flex flex-row  flex-wrap gap-1 h-[20%]  mb-4 text-xs ">
                    ...
                    {resume?.primarySkills.map((skill: string, i: number) => (
                      <li
                        ...
                        draggable
                      >
                        <span className="w-1 !block h-1 mr-3 bg-black rounded-full"></span>
          ...
          resume?.customExperienceArray.length > 0 ? (
            <>
              {resume?.customExperienceArray.map((rec: any, index: number) => {
                ...
                return (
                  <>
                    ...
                    <h3
                      ...
                      onDragOver={(e) => e.preventDefault()}
                      onDrop={(e) => handleDropSingleCustomSection(e, index)}
                      draggable
                    >
                      <EditableField
                        value={sectionName}
                        ...
                        >
                          ...
                          >
                            ...
                            <h2 className="flex gap-1 text-xs flex-wrap font-semibold leading-relaxed hover:cursor-default ">
                              ...
                              {entry.isContinue && (
                                <EditableField
                                  value={`${entry?.isContinue && "Present"}`}
                                  onSave={(value: string) => {
                                    handlers.handleSaveExperienceCustomDetail(
                                      { toYear: value },
                                      i,
                                ...
                                <>
                                  <div className="flex flex-wrap w-full gap-1 mt-4">
                                    <input
                                      className="w-full py-[4px] border-2 rounded-md  text bg-transparent " // Apply Tailwind CSS classes
                                      onChange={(e) =>
                                        setNewCustomAchievement(e.target.value)
                                      }
              ...
              <ul className="grid grid-cols-3 gap-2 xs:grid-cols-3 md:grid-cols-3  ">
                {resume?.education.map((education: Education, ind: number) => (
                  <React.Fragment key={education?.id || ind}>
                    <div className="md:m-2 relative group border-transparent border-2 hover:border-dashed hover:border-gray-500">
