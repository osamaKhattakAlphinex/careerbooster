...
const Certification = ({ i, rec }: Props) => {
  ...
  return (
    <Toolbar
      ...
      deleteExperience={() => handlers.handleDeleteOthers(i, "certifications")}
      // regenrateAchivements={() => handleRegenrate(rec, i)}
      addNewLine={() => {
        handlers.handleAddOthersSpace(i, newCertification, "certifications");
        setNewCertification("");
      }}
    >
      <div
      ...
      >
        ...
        <div className="px-4 py-1">
          ...
          {certificationIndex === i && newBulletSection === "Certifications" ? (
            <>
