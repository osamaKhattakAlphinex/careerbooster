      ...
      <div className=" flex  ">
        <div className="w-[75%]  md:w-[75%] flex  flex-col px-4 md:px-8  m-2">
          ...
          <Toolbar regenrateSummary={getSummary}>
            <div className="text-sm  my-2 hover:shadow-md border-2 border-transparent hover:border-gray-500 hover:border-dashed  min-h-[400px] xs:min-h-fit">
              <EditableField
                type="textarea"
                value={
                  resume?.summary !== "" ? (
              ...
              <ul className="flex  md:flex-row lg:flex-row w-full  flex-wrap pl-0 ">
                {resume?.education.map((education: Education, ind: number) => (
                  <React.Fragment key={education?.id || ind}>
                    <div className="w-[28%] xs:w-[48%] md:w-[30%] m-2 xs:m-0 relative  border-transparent border-2 hover:border-dashed hover:border-gray-500">
                      <li
