...
const RecentResumeCard = ({
  ...
  return (
    <>
      <div className="dark:bg-[#17151b] dark:text-white bg-[#00000015] text-gray-950 rounded-[20px]  mb-4 md:px-[24px] md:pt-[20px] md:pb-[20px] xs:px-[16px] xs:py-[12px] ">
        <div className="flex items-center gap-3">
          <h1 className=" flex gap-2 font-semibold md:text-[16px] xs:text-xs ">
            YOUR RESUMES
          </h1>
          <div className="group cursor-pointer  relative inset-0">
            {infoSmallIcon}
            <div className="w-36 md:w-40 z-50 bg-gradient-to-r  from-[#B324D7] to-[#615DFF] font-medium xs:text-[10px] md:text-[12px] px-2 absolute xs:left-1 md:left-3.5 xs:-top-12  md:-top-[60px]  hidden group-hover:block md:rounded-bl-none xs:rounded-bl-none  text-gray-100  mb-6 shadow-xl rounded-xl py-2  transition-all">
