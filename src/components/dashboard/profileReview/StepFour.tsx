...
const StepFour = () => {
  ...
  return (
    <>
      ...
      {state === "show" && (
        <>
          <h1 className="text-xl mt-12 font-bold w-full leading-tight tracking-tight dark:text-gray-100 text-gray-950  md:text-2xl ">
            Your Education
            <button
              type="button"
          ...
          <button
            type="button"
            onClick={(e) => dispatch(setStepFour({ state: "add" }))}
            className="w-full flex mt-4 flex-row gap-1 items-center justify-center text-blue-700 hover:text-white border-[1px] border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2"
          >
            {plusSimpleIcon}
            Add New Education
          </button>
