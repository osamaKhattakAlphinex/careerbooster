...
const SideBar = () => {
  ...
  const imageCroperRef: React.MutableRefObject<MessageViewerRef|null> = useRef(null);
  ...
  const handleImageChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    if(e.target.files){
      ...
      if (selectedFile) {
        ...
        reader.onloadend = () => {
          const base64Image: string = reader.result as string; // Convert the image blob to base64
