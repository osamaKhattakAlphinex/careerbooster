  ...
  return (
    <>
      <Link className="no-underline" href="/linkedin-optimizer/headline">
        <div className="headline-generator dark:bg-[#222027] dark:text-gray-50 bg-[#ffffff94] text-gray-950 py-2 md:py-8 px-1 lg:px-6 flex flex-col md:flex-row md:align-center xs:gap-2 md:gap-5 justify-center md:items-center rounded-[10px] xs:mb-[8px] md:mb-[20px]">
          <div className="w-16">
            <div
