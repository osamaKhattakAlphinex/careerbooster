  ...
  return (
    <div className="w-full">
      ...
      <div className="flex flex-col justify-center">
        <h3 className="text-center lg:px-10 lg:text-4xl font-semibold leading-normal lg:mt-3">
      ...
      <div className="mt-10 lg:mt-20 px-8">
        <h3 className="text-center text-3xl lg:px-10 pb-1 lg:text-4xl text-gray-100 font-semibold leading-normal mt-3">
