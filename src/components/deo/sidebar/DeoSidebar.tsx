  ...
  return (
    <div className="h-screen overflow-y-auto bg-gray-800 no-scrollbar">
      <div className="w-full h-full ">
        ...
        {/* Sidebar */}
        <ul className="flex flex-col h-full mt-4 px-2 p-0 pb-4 overflow-y-scroll text-sm sm:text-base">
          <li className="p-2 mb-1 sm:p-4">
            <Link
              href="/deo"
              className={` no-underline hover:no-underline font-semibold text-base hover:text-white/80 text-white`}
            >
