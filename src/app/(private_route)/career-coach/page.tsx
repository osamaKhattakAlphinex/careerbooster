      ...
      <div className="w-full sm:w-full z-1000 my-2">
        <div className="ml-0 lg:ml-[234px] px-[15px]">
          ...
          <div className="w-full h-[76vh] py-2 flex flex-col items-center rounded-xl single-service-bg ">
            ...
            >
              <input
                className="w-full rounded-md bg-transparent  outline-none border border-[#404044]  p-2 h-10 text-black"
                value={input}
                // onChange={(e) => {
                //   e.preventDefault();
              ...
              <button
                className="border-solid border border-[#404044] h-10 text-white p-2 rounded-md"
                type="submit"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
