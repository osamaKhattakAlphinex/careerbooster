    ...
    <>
      <div className="w-full sm:w-full z-1000 ">
        <div className="ml-0 lg:ml-[234px] px-[15px] mb-[72px] ">
          <Link
            href="/dashboard"
            className="ml-2 my-4 no-underline dark:text-[#b324d7] dark:hover:text-[#e6f85e] text-gray-950 hover:text-gray-10 flex flex-row gap-2 items-center ] hover:opacity-80 transition-all"
          >
            {leftArrowIcon}
            Back
          </Link>
            ...
            > */}
              ...
              <div className="flex flex-col gap-5 justify-between items-start">
                ...
                <button
                  ...
                  className={`dark:bg-gradient-to-r from-[#b324d7] to-[#615dff] dark:border-none dark:border-0 border border-gray-950 bg-transparent s flex flex-row justify-center items-center gap-2 py-3 px-[28px] rounded-full ${
                    (msgLoading ||
                      !session?.user?.email ||
                      !aiInputUserData ||
                      selectedOption === "" ||
                ...
                <div className="mt-[40px] ">
                  ...
                  <div className="buttons mt-5 flex flex-col md:flex-row gap-3">
                    <button
                      ...
                      onClick={handleGenerate}
                      className={`flex flex-row justify-center items-center gap-2 py-3 px-[28px]   rounded-full border border-[#b324d7] ${
                        (msgLoading ||
                          !session?.user?.email ||
                          !aiInputUserData ||
                          selectedOption === "" ||
                    ...
                    {show && (
                      <button
                        ...
                        className={` flex flex-row justify-center items-center gap-2 py-3 px-[28px]  border rounded-full dark:border-[#312e37]  border-[#b324d7] ${
                          msgLoading ||
                          !session?.user?.email ||
                          !aiInputUserData ||
                          selectedOption === "" ||
