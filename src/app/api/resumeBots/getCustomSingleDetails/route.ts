...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const inputPrompt = `
    Improve/Change and rewrite the work below to position ${personName} for the position of ${jobTitle} based on the following instructions:

    The work should be in the form of a bullet list (2 or 3 bullets only)
    ...
    Here is the work details: 
      ...
      Job Description: ${JSON.stringify(activity.achievements)}
