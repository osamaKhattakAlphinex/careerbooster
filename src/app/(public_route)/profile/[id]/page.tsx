...
import { UserDataType } from "../../../../../types/ObjTypes/types";
import { Industry } from "@/components/public-pages/Register/RegistraionForm";
...
const Page = ({ params }: { params: { id: string } }) => {
    ...
    onSubmit: async (values) => {
      ...
      axios
        ...
        .then((resp) => {
          ...
          dispatch(setField({ name: "industry", value: values.industry }));
  ...
  useEffect(() => {
    if (isUpdateFormOpen) {
      ...
      formik.setFieldValue("industry", userData?.industry);
      setIsEmployer("Yes");
      setOpen(true);
    }
  }, [isUpdateFormOpen]);
  ...
  if (
    ...
    if (userDetails.isLoading) {
      return (
        <div className=" flex flex-col items-center justify-center xs:mt-[90px] lg:mt-52 md:mt-28 md:px-20 xs:px-4 xs:text-center mb-10 min-h-[calc(75vh_-_20rem)]">
                ...
                <div className="relative bg-white rounded-lg shadow pb-20 dark:bg-gray-700 max-w-3xl mx-auto">
                  ...
                  <form onSubmit={formik.handleSubmit}>
                    ...
                    <button className="bg-blue-600 hover:bg-blue-800 rounded-md px-4 py-2 justify-center flex text-gray-100 md:text-[20px] xs:text-[16px] w-fit mx-auto">
                      {loading ? refreshIconRotating : "Update Profile"}
                    </button>
                  </form>
                </div>
              </div>
