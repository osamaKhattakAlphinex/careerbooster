...
const saveToLocalStorage = (text: any, fileName: any) => {
  localStorage.setItem("resume-content", text);
...
const LinkedInToolMain = () => {
  ...
  useEffect(() => {
    if (isVerified) {
      router.push("/new-email-generator/result");
    } else {
    ...
    <div className="w-full ">
      ...
      <section className="hero bg-gradient-to-r from-[#01010D80] via-[#000A6380] to-purple-900 overflow-x-hidden lg:px-0 pt-7  lg:pt-[30px]	px-5 lg:npt-10">
        ...
        <div className="flex justify-center pt-10 pb-14 lg:pb-20">
          <span
            ...
            className="flex justify-center w-20 py-2 text-indigo-500 border-indigo-500 cursor-pointer lg:mt-4 rounded-t-2xl rounded-b-2xl border-1 animate-bounce"
          >
            {ArrowDownIcon}
          </span>
        </div>
      ...
      <section className=" bg-gradient-to-r from-[#01010D80] via-[#000A6380] to-[#4C019180] py-20">
        ...
        <div className="md:px-10 xs:px-4 ">
          <div className="flex flex-col items-center justify-center w-full mb-3 border-gray-800 lg:h-80 rounded-2xl mt-14 bg-gradient-to-r to-fuchsia-600 from-indigo-500 lg:px-10">
            <div className="lg:w-10/12 flex justify-center items-center flex-col lg:my-4 my-[28px] lg:mx-0 mx-5 ">
              ...
              <p className="mt-4 text-xl text-center text-normal">
                Simply Upload your Resume or LinkedIn Profile in PDF
              </p>
              <button
                className="w-56 py-3 mt-4 text-xl font-bold text-center text-gray-800 bg-yellow-400 rounded-full bg-opacity-80 h-14 hover:bg-yellow-600 px-9"
