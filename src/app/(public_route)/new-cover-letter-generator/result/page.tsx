...
const page = () => {
  return (
    <>
      <div className="  xs:mt-[68.88px] lg:mt-[90.06px] mx-auto md:container dark:text-white  text-gray-950 rounded-[20px] px-4 lg:px-[30px] py-6  flex flex-col gap-3 ">
        {/* header */}
          ...
          >
            {false ? (
              ...
              <div className="flex flex-row items-center justify-center gap-2">
                ...
                <span className="text-xs capitalize dark:text-gray-300 text-gray-950 md:text-sm hover:text-blue-500">
                  Generate Cover Letter
                </span>
              </div>
            )}
