...
export default function PrivacyPloicyPage() { 
  return (
    <>
      <main className="flex-grow-1 my-28 py-10">
        <div className="container">
          <div className="privacy-policy py-5">
            ...
            <p className="text-[16px]">
              ...
              the unrevised information in our records. We will retain your
              information for as long as your account is active or as needed to
              provide you Services. Some information may remain in our private
            ...
            <p className="text-[16px]">
              ...
              process transactions; send notification emails such as password
              reminders, updates, etc; run and operate our Website and Services.
            ...
            <p className="text-[16px]">
              ...
              deleted. Where necessary for processing future payments and
              subject to your prior consent, your financial information will be
              stored in encrypted form on secure servers of our reputed payment
              gateway service provider who is beholden to treating your Personal
              Information in accordance with this Privacy Policy. All direct
              payment gateways adhere to the latest security standards as
            ...
            <p className="text-[16px]">
              ...
              CareerBooster.AI in excess of the amount payable or due by the
            ...
            <p className="text-[16px]">
              ...
              by the terms of this Policy, you are not authorized to use or
