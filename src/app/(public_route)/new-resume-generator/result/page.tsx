...
const page = () => {
  return (
    <div className="  xs:mt-[68.88px] lg:mt-[90.06px] dark:text-white md:container mx-auto text-gray-950  py-6 px-4 md:px-[30px] flex flex-col gap-4 ">
      {/* header */}
      <div className="flex  flex-col items-center justify-between gap-2 md:flex-row">
        <h3 className=" text-[16px] md:text-xl uppercase dark:text-gray-100 text-gray-950 font-bold">
          generate new resume
        </h3>
      ...
      <div className="flex  flex-col items-start justify-between gap-5">
        <div className="w-full flex flex-col gap-4">
          <label
            ...
            className=" font-bold items-center dark:text-gray-100 text-gray-950 text-md md:text-[16px] flex flex-row gap-[10px]"
          >
            <Image
              src="/icon/rocket.svg"
              alt="bold icon"
            ...
            <div className="group cursor-pointer relative inset-0">
              {infoSmallIcon}
              <div className="w-56 bg-gradient-to-r z-50 from-[#B324D7] to-[#615DFF] font-medium xs:text-[10px] md:text-[14px] px-2 absolute xs:-left-56 md:left-[0.5rem] xs:-top-24  md:-top-[9rem]  hidden group-hover:block md:rounded-bl-none xs:rounded-br-none md:rounded-br-xl text-gray-100  mb-6 shadow-xl rounded-xl py-2  transition-all">
          ...
          <input
            ...
            className="w-full py-3 px-[26px] rounded-full text-sm text-[#959595] bg-transparent border-[#312E37] border-[1px]"
          />
        </div>
        ...
        <button
          ...
          // }
          // onClick={() => getConsent()}
          className={` dark:bg-gradient-to-r hover:from-purple-800 hover:to-pink-600 from-[#b324d7]  to-[#615dff] dark:border-none dark:border-0 border-[1px] border-gray-950 bg-transparent flex flex-row justify-center items-center gap-2 py-3 px-[26px]  rounded-full `}
          // ${
          //   memoizedState.jobPosition === "" ||
          //   memoizedState.resumeLoading ||
          //   !session?.user?.email
