...
function page() {
  ...
  return (
    <>
      <section className="md:pt-20 xs:pt-[120px] xs:pb-[50px] pb-10  md:pb-18  dark:bg-gray-950 bg-gray-100 dark:text-white text-black  justify-center items-center min-h-screen flex flex-col">
        <div className="text-center p-6 w-2/3 flex flex-col gap-2 pb-20">
          <h1
            className={`text-[54px] !font-extrabold mb-4 ${montserrat_r.className}`}
          >
            Give Us 30-60 Days & We{"'"}ll Find You a Dream Job!
          </h1>
          <p
            className={`mb-6 ${montserrat_r.className} text-[22px] text-gray-200`}
          >
            Our team of dedicated Virtual Job Search Assistants can make your
            life easier by managing your entire job search. Save time and do
            what you love while we bring you the interviews.
          </p>
          <Link
            target="_blank"
            href="https://calendly.com/callofcareer/15min"
            className={`${montserrat_r.className} text-[20px] bg-[#BD10E0] text-white  py-4 px-8 rounded-full hover:bg-purple-700 transition duration-300 !font-bold mt-4 w-fit mx-auto `}
          >
            Schedule a Free Consultation →
          </Link>
        </div>
        <div className="bg-[#E5EFF7] text-gray-900 py-10 px-6 w-full">
          <div className="mx-auto text-center px-10">
            <h2
              className={`text-[40px]  mb-4 !font-extrabold ${montserrat_r.className}`}
            >
              As A Senior-Level Candidate You Have Already Realized That Finding
              A Job Is Tricky And Complicated
            </h2>
            <ul
              className={`text-[#595757] text-left list-disc list-inside space-y-2 mb-6 text-[25px] ${montserrat_r.className}`}
            >
              <li>
            ...
            <p
              className={`text-gray-950 space-y-2 mb-6 text-[30px] !font-extrabold ${montserrat_r.className}`}
            >
              To overcome these challenges, here is what we can do to help you
              find your dream job faster.
            </p>
            <p
              className={`text-[#595757]mb-6 text-[25px] ${montserrat_r.className}`}
            >
              ...
              techniques that put you in front of the decision makers and give
              you access to confidential and unannounced opportunities.
            </p>
          </div>
        </div>
        <div className=" text-white py-10 px-6">
          <div className="px-10 mx-auto">
            <h2
              className={`text-[50px] !font-extrabold text-center mb-2 ${montserrat_r.className}`}
            >
              How do we do it?
            </h2>
            <p
              className={`text-center mb-10 text-[24px] text-gray-400 ${montserrat_r.className} !font-extrabold`}
            >
            ...
            <div className="space-y-8">
              <div className="flex">
                <div className="flex flex-col">
                  <div
                    className={`flex-none w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center font-bold mr-8 ${montserrat_r.className} text-[36px] mb-6`}
                  >
                    1
                  </div>
                  <div className="h-[100%] border-l-2 border-gray-400 mx-auto"></div>
                </div>

                <div>
                  <h3
                    className={`mb-6 text-[36px] !font-extrabold  ${montserrat_r.className}`}
                  >
                  ...
                  <p
                    className={`text-gray-400 ${montserrat_r.className} text-[20px]`}
                  >
                    The modern-day job search is not like it used to be. Long
                    gone are the days of applying for jobs online and getting
                    calls for interviews. A job search is in essence a marketing
                    campaign with you as the product, and your executive job
                    search strategy equates to your marketing campaign.
                  </p>{" "}
                  <br />
                  <p
                    className={`text-gray-400 ${montserrat_r.className} text-[20px]`}
              ...
              <div className="flex">
                <div className="flex flex-col ">
                  <div
                    className={`flex-none w-12 h-12 bg-orange-600 rounded-full flex items-center justify-center  font-bold mr-8 ${montserrat_r.className} text-[36px] mb-6`}
                  >
                    2
                  </div>
                  <div className="h-[100%] border-l-2 border-gray-400 mx-auto"></div>
                ...
                <div>
                  <h3
                    className={`text-[36px] !font-extrabold mb-2 ${montserrat_r.className} text-orange-400`}
                  >
                  ...
                  <div className="border-orange-600 border-2 p-4">
                    ...
                    >
                      ...
                      job openings that are accessible only to those who look
              ...
              <div className="flex">
                <div className="flex flex-col">
                  <div
                    className={`flex-none w-12 h-12 bg-red-600 rounded-full flex items-center justify-center  font-bold mr-8 ${montserrat_r.className} text-[36px] mb-6`}
                  >
                    3
                  </div>
                  <div className="h-[100%] border-l-2 border-gray-400 mx-auto"></div>
                ...
                <div>
                  ...
                  >
                    ...
                    will upload all jobs in a separate excel sheet for you so
                    you can review and track them yourself whenever you want.
                  </p>
                </div>
              </div>
              <div className="flex">
                <div className="flex flex-col">
                  <div
                    className={`flex-none w-12 h-12 bg-green-600 rounded-full flex items-center justify-center  font-bold mr-8 ${montserrat_r.className} text-[36px] mb-6`}
                  >
                    4
                  </div>
                  <div className="h-[100%] border-l-2 border-gray-400 mx-auto"></div>
              ...
              <div className="flex">
                <div className="flex flex-col">
                  <div
                    className={`flex-none w-12 h-12 bg-purple-600 rounded-full flex items-center justify-center  mr-8 ${montserrat_r.className} text-[36px] mb-6`}
                  >
                    5
                  </div>
                  <div className="h-[100%] border-l-2 border-gray-400 mx-auto"></div>
                ...
                <div>
                  ...
                  >
                    ...
                    you, you can also pull their email address from their
                    profile and email them your résumé/cover letter.
                  </p>
                  <br />
                  <p
                    className={`text-gray-400 ${montserrat_r.className} text-[20px]`}
                  >
                    ...
                    might not seem significant at first glance, but it can
                    really help as you apply to a few jobs at a few companies.
                    Without this order, it can get very confusing.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="bg-[#E4ECF2] mt-20 rounded-l-3xl rounded-b-3xl p-6 shadow-md  flex   w-[80%] mx-auto text-gray-400">
          <div className="flex items-center ">
            ...
            <div className="text-left w-2/3">
              ...
              <p className={`mt-4 ${montserrat_r.className} text-[20px]`}>
              ...
              <p className={`mt-4 ${montserrat_r.className} text-[20px]`}>
                By outsourcing the work you don{"’"}t enjoy you can focus on
        ...
        <div className="bg-gray-950 w-full mt-20">
          <div className="content text-center w-2/3 mx-auto">
            <h1
            ...
            <p className={`text-[20px] ${montserrat_r.className} pt-6`}>
              Finding a senior level job can be much easier than you think. Many
              people simply don’t know the correct steps to take which makes
              them take far longer than they need to. We’ll do all the hard work
              and smart work for you, and you’ll find your next job in no time.
            </p>
          </div>
        </div>
        <div className="flex justify-center p-4 w-full gap-4 px-14 mt-20">
          {/* Without Find Job4Me */}
          <div className="bg-gray-100 text-gray-950  shadow-md mx-2 w-1/2">
            <div
              className={`bg-red-700 p-4  text-center font-bold ${montserrat_r.className} text-[23px] !font-extrabold`}
            >
              Without Find Job4Me
            </div>
            <div className="bg-white text-black ">
              <p
                className={`text-gray-950 ${montserrat_r.className} text-[23px] p-4 text-center`}
              >
                <strong>Estimated Time to First Interview 6 months.</strong>
              </p>
              <p
                className={`text-gray-950 ${montserrat_r.className} text-[23px] p-4 text-center bg-[#E4ECF2]`}
              >
          ...
          {/* With Find Job4Me */}
          <div className="bg-green-600 text-gray-950  shadow-md mx-2 w-1/2">
            <div
        ...
        <div className="bg-gray-950 w-full mt-20">
          <div className="content text-center w-2/3 mx-auto">
            <h1 className={`text-[40px] ${montserrat_r.className} !font-bold `}>
            ...
            <Link
              target="_blank"
              href="https://calendly.com/callofcareer/15min"
              className={`${montserrat_r.className} !font-bold text-[24px] bg-[#BD10E0] p-4  rounded-lg hover:bg-purple-700 transition duration-300`}
            >
              Schedule A free Consultation
            </Link>
          </div>
        </div>
        <div className="faqs flex flex-col w-[80%] px-10 mx-auto mt-20">
          <h1
            className={`${montserrat_r.className} text-[40px] !font-bold text-center my-10`}
          >
          ...
          {faqs.map((faq: any) => {
            return (
              <>
                ...
                <h1
                  className={`${montserrat_r.className} !font-bold text-[34px] mb-8`}
                >
                  Q: {faq.question}
                </h1>
                <p
                  className={`${montserrat_r.className} !font-bold text-[23px] mb-12`}
                >
                  A: {faq.answer}
                </p>
              </>
        ...
        <div className="w-full py-16 bg-[#63B3ED]"></div>
      </section>
    </>
  );
}
