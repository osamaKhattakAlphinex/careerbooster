...
export interface CreditModalRef {
  openModal: (arg1: boolean, arg2: CreditPerUsage | null) => void;
}

const CreditPerUsagePage = () => {
  const [loading, setLoading] = useState<boolean>(false);
  const [credits, setCredits] = useState<CreditPerUsage | null>(null);
  const creditModalRef: React.MutableRefObject<CreditModalRef | null> = useRef(null);
