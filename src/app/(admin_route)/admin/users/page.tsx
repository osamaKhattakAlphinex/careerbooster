...
export interface CreditsUpdationRef {
...
const UsersPage = () => {
  ...
  const creditsUpdationModelRef: React.MutableRefObject<CreditsUpdationRef | null> =
    useRef(null);
  ...
  const selectUsersLimit = (e: React.ChangeEvent<HTMLSelectElement>) => {
    setCurrentPage(1);
    setLimitOfUser(parseInt(e.target.value,10));
  };
