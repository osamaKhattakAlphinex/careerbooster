...
import { MessageViewerRef } from "../contacts/page";
...
const FineTuningModels = () => {
  ...
  const settingModelRef: React.MutableRefObject<MessageViewerRef | null> = useRef(null);
      ...
      actions: [
        {
          name: "create",
          type: "handler",
          element: (rec: FineTuningModelsType) => createFineTuningJob(rec),
          styles:
        ...
        },
        {
          name: "delete",
          type: "handler",
          element: (rec: FineTuningModelsType) => deleteFileFromOpenAI(rec),
          styles:
      ...
      actions: [
        {
          name: "cancel",
          type: "handler",
          element: (rec: FineTuningModelsType) => cancelFineTuningJob(rec),
          styles:
        ...
        },
        {
          name: "status",
          type: "handler",
          element: (rec: FineTuningModelsType) => getTuningJobStatus(rec),
          styles:
  ...
  const createFineTuningJob = async (rec: FineTuningModelsType) => {
