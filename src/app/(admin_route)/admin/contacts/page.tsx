...
export interface MessageViewerRef {
...
const Contacts = () => {
  ...
  const messageViewerRef: React.MutableRefObject<MessageViewerRef | null> = useRef(null);
  ...
  const actions: TableAction[] = [
    {
      name: "view",
      type: "handler",
      element: (rec) => viewMessageHandler(rec),
      styles:
