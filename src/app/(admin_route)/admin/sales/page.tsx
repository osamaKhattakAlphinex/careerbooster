...
const Sales = () => {
  ...
  const columns = [
    ...
    columnHelper.accessor("service", {
      ...
      header: () => "Service",
      cell: (info) => {
        const services = info.renderValue() as Service[];
        const labels = services.map((service: Service) => service.label);
        return labels.join(", ");
      },
    }),
  ...
  const actions: TableAction[] = [
    {
      name: "Change Status",
      type: "component",
      element: (sale: Sale) => <ChangeStatus sale={sale} refetch={fetchSales} />,
      styles: "",
      icon: boltIcon,
    },
    {
      name: "Delete",
      type: "component",
      element: (sale: Sale) => <DeleteSale sale={sale} refetch={fetchSales} />,
      styles: "",
      icon: deleteIcon,
    },
  ];
